...
//            st = con.createStatement();
            ...
            st.executeUpdate("create view View1 as\n"
                    +"select *\n"
                    + "	from Certificated C\n"
                    +"where not name = any(select C1.name from Certificated C1, Violated V1\n"
                    + "						  where C1.name=V1.name and C1.areaname=V1.areaname);\n");
            st.executeUpdate("create view View2 as \n"
                    + "select distinct * \n"
                    + "from Violated;");
            st.executeUpdate("create view View3 as \n"
                    + "select distinct *\n"
                    + "	from Certificated C\n"
                    + " where not name = any(select C1.name from Certificated C1, Violated V1\n"
                    + "						  where C1.name=V1.name and C1.areaname=V1.areaname);\n");

            st.executeUpdate("create view View4 as SELECT * from Certificated where name not in (select distinct name from Violated );");
            st.executeUpdate("create view View5 as \n"
                    + "select distinct *\n"
                    + "	from Certificated C\n"
                    + "	where not name = any(select C1.name from Certificated C1, Violated V1\n"
            ...
            while (select != 6){
                ...
                if(select == 1){
                    ...
                    String sql = "select * from View1 where areaname = '" +select_menu1+"';";
...
//                                    frameReview.setVisible(true);
                    ...
                    String sql = "select * from View2 where areaname = '" + select_menu2 + "';";
                    rs = st.executeQuery(sql);
                    int i = 0;
...
//                                    frame.add(label);
                    ...
                    String sql = "select * from View3 where type = '"+menu+"';";
                    rs = st.executeQuery(sql);
                    int i = 0;
...
//                                    frameReview.add(spReview, "Center");
                    ...
                    String sql = "select * from View4 where name = '"+store_name+"';";
...
//                    }
                    ...
                    String sql = "select * from View5 where areaname ='"+select_menu1+"';";
                    rs = st.executeQuery(sql);
